...
namespace SelfHostedWebApiDataService.Models.Mapping
{
    public class EventMap : EntityTypeConfiguration<Event>
    {
        public EventMap()
        {
            ...
            this.Property(t => t.ReminderInfoXml)
                .HasMaxLength(200);
            ...
            this.Property(t => t.RemindIn).HasColumnName("RemindIn");
            this.Property(t => t.ReminderInfoXml).HasColumnName("ReminderInfoXml");
            this.Property(t => t.AlarmTime).HasColumnName("AlarmTime");
            this.Property(t => t.IsPostponed).HasColumnName("IsPostponed");
